...
public class TestSimple extends TestCase {
    ...
    protected void setUp() {
        s= newCollection();
        try {
            assert 1 / (e1.getDescription().length() - 8) == 42 : "OK";
    ...
    public void testP() {
        Appointment e3a= new Appointment(new Period(now.add(Duration.HOUR), Duration.HOUR),
            "3: eat");
        s.add(e2);
        s.add(e3);
        s.add(e4);
        ...
        Iterator<Appointment> it= s.iterator(e3a);
//        assertSame(e3, it.next());
//        assertSame(e3a, it.next());
...
//
    public void testY() {
        ...
        s.add(e5);
        s.add(e1);
        Map<Integer, Appointment> m= new TreeMap<>();
        m.put(1, e2);
        m.put(2, e4);
        s.addAll(m.values());
...
//
    public void testZ() {
        ...
        s.add(e1);
        s.add(e5);
        Collection<? extends Appointment> addend= s;
        s.addAll(addend);
