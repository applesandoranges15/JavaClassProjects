...
public class TestApptBook extends TestCase {
    ...
    Appointment e6= new Appointment(new Period(now.add(Duration.DAY), Duration.DAY), "5: tomorrow");
    Appointment e7= new Appointment(
        new Period(now.add(Duration.DAY).add(Duration.YEAR), Duration.DAY), "5: tomorrow");
    ApptBook s;
    ...
    protected void setUp() {
        ...
        try {
            ...
            System.err.println(
                "In Eclipse: add -ea in the VM Arguments box under Run>Run Configurations>Arguments");
            assertFalse(
                "Assertions must be -ea enabled in the Run Configuration>Arguments>VM Arguments",
                true);
    ...
    protected <T> void assertException(Class<?> excClass, Supplier<T> producer) {
        try {
            ...
            if (!excClass.isInstance(ex)) {
                assertFalse("Wrong kind of exception thrown: " + ex.getClass().getSimpleName(),
                    true);
            }
        }
    }
    ...
    public void test00() {
        ...
        s.start();
        assertFalse(s.isCurrent());
        System.out.println(e7.compareTo(e1) > 0);
        System.out.println(e7.compareTo(e2) > 0);
        System.out.println(e7.compareTo(e3) > 0);
        System.out.println(e7.compareTo(e4) > 0);
        System.out.println(e7.compareTo(e5) > 0);
        System.out.println(e7.compareTo(e6) > 0);
        System.out.println(e7.compareTo(e1) > 0);
    }
    ...
    public void test16() {
        ...
        Appointment e4a= new Appointment(
            new Period(now.add(Duration.HOUR.scale(2)), Duration.HOUR.scale(8)), "4: sleep");
        s.setCurrent(e4a);
        assertSame(e4, s.getCurrent());
        s.setCurrent(e5);
